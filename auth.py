...
def check_restaurant_access(current_user: db_models.User, restaurant_id: int):
    if current_user.role == "headquarters":
        return True
    elif current_user.role == "restaurant" and current_user.restaurant_id == restaurant_id:
        return True
    else:
        return False
